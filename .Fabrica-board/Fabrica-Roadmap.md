...
| **C — Post-Beta Growth**                | Update pipeline proven + app + relay + plugins tested | First public Beta release. Landing page live checks flip WEB-W1..W10 VERIFY→DONE. Marketing begins daily content publishing.                                                                                                     |
...
| Marketing plans (M1–M3)                           | ✅ Done         | Fabrica-marketing | M1 brand guidelines, M2 competitor landscape, M3 positioning statement — all complete                                                                                                                                                                                                                                                                                                                                                                         |
| Marketing strategy &amp; content (M4–M11)         | ⬜ TODO         | Fabrica-marketing | M4 align with app, M5 update web copy, M6 regenerate images, M7-M9 strategy/calendar/setup, M10-M11 content/publish                                                                                                                                                                                                                                                                                                                                           |
...
| APP-G6-APK build (EAS)                            | ✅ Done         | Fabrica-app       | APK built: [https://expo.dev/artifacts/eas/-sZ8VjUyqnUyJaGJR64PsTShJEbHrTdYrieODLyG7U8.apk](https://expo.dev/artifacts/eas/-sZ8VjUyqnUyJaGJR64PsTShJEbHrTdYrieODLyG7U8.apk) (v0.0.43, versionCode 12)                                                                                                                                                                                                                                                         |
...
| 6   | G6-RUN: build Fabrica APK via EAS                                                          | Fabrica-app       | PM EAS login | ✅ Done — APK: [https://expo.dev/artifacts/eas/-sZ8VjUyqnUyJaGJR64PsTShJEbHrTdYrieODLyG7U8.apk](https://expo.dev/artifacts/eas/-sZ8VjUyqnUyJaGJR64PsTShJEbHrTdYrieODLyG7U8.apk) |
...
| Fabrica-update    | Orca↔Fabrica diff analytics + sync workflow                               | `Fabrica-update/.Fabrica-update-board/Fabrica-update-tasks.md`          |
...
| --------- | ------------------------------- | -------------------- | ---------------------------- | ---------------------------------------------------------------------- |
| APP       | App-orchestrator (root level)   | `Fabrica-app/`       | `Fabrica-app-tasks.md`       | **active** — 35 tasks, 10 DONE, 10 TODO, 7 BLOCKED (29%)               |
...
| WEB       | *(dormant until Phase B)*       | `Fabrica-web/`       | `Fabrica-web-tasks.md`       | dormant (51/51 done — 100%)                                            |
| MARKETING | *(dormant until Phase C)*       | `Fabrica-marketing/` | `Fabrica-marketing-tasks.md` | dormant (10 tasks, 3 done — 30%)                                       |
| PLUGINS   | *(dormant)*                     | `Fabrica-plugins/`   | `Fabrica-plugins-tasks.md`   | dormant (18/18 done — 100%)                                            |
| RELAY     | *(dormant)*                     | `Fabrica-relay/`     | `Fabrica-relay-tasks.md`     | dormant (32/32 done — 100%)                                            |
| UPDATE    | *(dormant)*                     | `Fabrica-update/`    | `Fabrica-update-tasks.md`    | dormant (4 tasks, 0 done — 0%)                                         |
...
- 2026-08-31 Fabrica-marketing fresh start + new tasks: PM removed all external/ and assets/. Old 27-task file archived. New file: 10 tasks — M1-M3 brand foundation DONE, M4 (analyse app + update brand files), M5 (update web copy), M6 (regenerate images), M7-M9 (strategy/calendar/setup), M10-M11 (content/publish). Grand total corrected: 165 tasks, 146 DONE, 19 TODO = 89%.
- 2026-09-01 Dashboard reconciliation: all sub-project task file counts synced to actual source of truth. Corrected Fabrica-app from 49/42/86% to 35/10/29% (actual: 10 DONE, 10 TODO, 7 BLOCKED). Corrected Fabrica-plugins from 20 to 18 tasks. Corrected Fabrica-update from 6/1/17% to 4/0/0%. Added Fabrica-update to Sub-Project Index and Standing Orchestrator Slots. Fixed stale M1-M13/M14-M18 references (archived tasks). Fixed duplicate Phase B/C labels. Grand total: 150 tasks, 114 DONE, 7 BLOCKED, 29 TODO = 76%.

---

*Last updated: 2026-09-01 (Dashboard reconciliation. All sub-project task file counts synced. Corrected: Fabrica-app 35 tasks/10 DONE/29%, Fabrica-plugins 18 tasks, Fabrica-update 4 tasks/0 DONE. Added Fabrica-update to Sub-Project Index and Standing Orchestrator Slots. Fixed stale M1-M18 references. Grand total 150 tasks, 114 DONE, 7 BLOCKED, 29 TODO = 76%.)*