...
|--------|------|-----------|
| `Fabrica-app/` | `Auto-Scalers/Fabrica-app` | Desktop app (Electron + Next.js, forked from Orca) |
| `Fabrica-web/` | `Auto-Scalers/Fabrica-web` | Landing page (Next.js, hosted on Vercel) |
...
├── .Fabrica-Board/                  ← Top-level roadmap & goals
├── AGENTS.md                        ← Orchestrator agent instructions
└── README.md                        ← This file
```

Each folder is its own git repo with its own `AGENTS.md` (agent instructions), `README.md` (what this folder is), and `.Fabrica-{name}-board/` (planning docs).
...
- The top-level `AGENTS.md` explains how the orchestrator coordinates across all 3 folders
